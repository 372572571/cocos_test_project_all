import { GAME_TYPE } from "../../prefab/gameIcon/GameIcon";
...
export enum UPDATE_TYPE {
    ...
    READY_TO_UPDATE = 'READY_TO_UPDATE'// 准备更新
}

export class ChildHotUpdate {
    ...
    // 查找更新
    public FindUpdate(data: { url: string, storagePath: string, path: string }): Promise<any> {
        return new Promise((resolve, rejects) => {
            ...
            this._manifestUrl = data.path;
            this._am = new jsb.AssetsManager(this._packageUrl, this._storagePath, this.versionCompare.bind(this)) // 远程版本比较回调
            ...
            this._am.setEventCallback(checkCb);
